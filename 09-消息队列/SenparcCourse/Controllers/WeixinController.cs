...
namespace SenparcCourse.Controllers
{
    ...
    {
        //自动识别 WebConfig中的配置信息
        public static readonly string Token = ConfigurationManager.AppSettings["WeixinToken"];//Config.SenparcWeixinSetting.Token;//与微信公众账号后台的Token设置保持一致，区分大小写。 
        ...
        public ActionResult Post(PostModel postModel)
        {
             ...
             * 收到重复消息通常是因为微信服务器在5秒内没有及时收到应用用品的响应，会持续发送2-5条不等的相同MsgId相同内容的RequestMessage*/
